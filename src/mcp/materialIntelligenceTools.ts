...
export const EDITKIN_MCP_INSTRUCTIONS = [
  "Editkin is a local STDIO editing tool controlled by the user's current Codex or Claude Code session; never request an Editkin API key or AI provider token.",
